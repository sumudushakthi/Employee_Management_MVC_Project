...
namespace EmployeeManagement.Controllers
{
    public class SystemCodeDetailsController : Controller
    {
        ...
        {
            ViewData["SystemCodeId"] = new SelectList(_context.SystemCode, "Id", "Description");
            return View();
        }
        ...
        public async Task<IActionResult> Create( SystemCodeDetail systemCodeDetail)
        {
            ...
            systemCodeDetail.CreateOn = DateTime.Now;
            systemCodeDetail.CreateByID = Userid;

            _context.Add(systemCodeDetail);
            await _context.SaveChangesAsync(Userid);
            return RedirectToAction(nameof(Index));
            ViewData["SystemCodeId"] = new SelectList(_context.SystemCode, "Id", "Description", systemCodeDetail.SystemCodeId);
            return View(systemCodeDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SystemCodeId,Code,Description,OrderNo,CreateByID,CreateOn,ModifiedByID,CModifiedOn")] SystemCodeDetail systemCodeDetail)
        {
