...
namespace EmployeeManagement.Controllers
{
    public class ApprovalsUserMatricesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ApprovalsUserMatrixs.Include(a => a.DocumentType).Include(a => a.User).Include(a => a.WorklowUsergroup);
        ...
        public async Task<IActionResult> Create( ApprovalsUserMatrix approvalsUserMatrix)
        {
            ...
            approvalsUserMatrix.CreateByID = Userid;
            approvalsUserMatrix.CreateOn=DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,DocumentTypeId,WorkflowUserGroupId,Active,CreateByID,CreateOn,ModifiedByID,CModifiedOn")] ApprovalsUserMatrix approvalsUserMatrix)
        {
