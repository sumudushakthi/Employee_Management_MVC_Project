...
namespace EmployeeManagement.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create( EmployeeViewModel newemployee,IFormFile employeephoto)
        {
            ...
            ViewData["BankId"] = new SelectList(_context.Bank, "Id", "Name",employee.BankId);
            ViewData["EmploymentTermsId"] = new SelectList(_context.SystemCodeDetails.Include(x => x.SystemCode).Where(x => x.SystemCode.Code == "Gender"), "Id", "Description",employee.EmploymentTermsId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmpNo,FirstName,MiddletName,LastName,PhoneNumber,EmailAddress,Country,DateOfBirth,Address,Department,designation,CreateByID,CreateOn,ModifiedByID,CModifiedOn")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
