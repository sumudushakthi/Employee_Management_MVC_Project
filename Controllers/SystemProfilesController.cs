...
namespace EmployeeManagement.Controllers
{
    public class SystemProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create(SystemProfile systemProfile)
        {
                ...
                systemProfile.CreateByID = Userid;
                systemProfile.CreateOn = DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ProfileId,Order,CreateByID,CreateOn,ModifiedByID,CModifiedOn")] SystemProfile systemProfile)
        {
            if (id != systemProfile.Id)
            {
                ...
                try
                {
                    ...
                    systemProfile.CModifiedOn = DateTime.Now;
