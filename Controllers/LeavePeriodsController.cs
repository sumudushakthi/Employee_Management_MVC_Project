...
namespace EmployeeManagement.Controllers
{
    public class LeavePeriodsController : Controller
    {
        ...
        public async Task<IActionResult> Create(LeavePeriod leavePeriod)
        {
            ...
            leavePeriod.CreateByID=Userid;
            leavePeriod.CreateOn=DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,StartDate,EndDate,Closed,Locked,CreateByID,CreateOn,ModifiedByID,CModifiedOn")] LeavePeriod leavePeriod)
        {
