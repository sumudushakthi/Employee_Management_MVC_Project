...
namespace EmployeeManagement.Controllers
{
    public class SystemCodesController : Controller
    {
        ...
        {
            var systcodes = await _context.SystemCode
        ...
        public async Task<IActionResult> Create( SystemCode systemCode)
        {
            ...
            systemCode.CreateOn=DateTime.Now;
            systemCode.CreateByID = Userid;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Description,CreateByID,CreateOn,ModifiedByID,CModifiedOn")] SystemCode systemCode)
        {
            if (id != systemCode.Id)
            {
                return NotFound();
        ...
        {
            return _context.SystemCode.Any(e => e.Id == id);
        }
    }
}
