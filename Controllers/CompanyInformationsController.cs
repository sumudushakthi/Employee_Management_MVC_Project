...
namespace EmployeeManagement.Controllers
{
    public class CompanyInformationsController : Controller
    {
        ...
        public async Task<IActionResult> Create(CompanyInformation companyInformation,IFormFile logo)
        {
            ...
            if (logo.Length > 0)
            {
                var fileName = "CompanyLogo" + DateTime.Now.ToString("yyyymmddhhmmss") + "_" + logo.FileName;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,PhoneNo,NSSFNO,NHFINO,KRAPIN,ContactPerson,Logo,PostalCode,CityId,CountryId")] CompanyInformation companyInformation)
        {
